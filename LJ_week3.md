...
This week I learned the some of the more intrict aspects of WordPress while creating my first full site using it. I also learned about vagrant, scotch box, and virtual box. I did so by using the provided materials and some independent searching on different forums and walkthroughs. I also participated in the group interview process. 
...
Learning more about WordPress and how to use it in more creative ways is an essentially stepping stone for web design, give it is the most used CMS on the market. Additionally, knowing how to host websites from my own computer will be an incredibly useful resource. I am excited to do more group work as I believe that the experience of working with others will give me an early insight into how groups work in the buisness world. If I can learn more now, then I will be more ready and capable in the future. 
